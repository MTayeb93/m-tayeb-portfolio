...
const CustomMobileLink = ({ href, title, className = '', toggle }) => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`
      h-[1px] inline-block bg-dark absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 dark:bg-dark
      ${router.asPath === href ? 'w-full' : 'w-0'}
      `}
      >
        &nbsp;
    ...
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:p-8'>
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
          ...
          <motion.a
            href='https://github.com/MTayeb93'
            target={'_blank'}
            className='w-6 mx-3'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href='https://www.linkedin.com/in/mohamad-tayeb-595599187/'
            target={'_blank'}
            className='w-6 mx-3'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          {/* <motion.a
            href='https://https://www.pinterest.com'
            target={'_blank'}
            className='w-6 mx-3'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <button
            ...
            className={`ml-3 flex item justify-center rounded-full p-1 
      ...
      {isOpen ? (
        ...
        className='min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-dark/90 dark:bg-light/90 rounded-lg backdrop-blur-md py-32'>

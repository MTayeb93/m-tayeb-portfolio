      ...
      <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
          ...
          <Details
            position={'Frontend web developer Intern'}
            company={'Frontliners'}
            companyLink={'https://www.frontliners.ai/'}
            time={'2022-2022'}
            address={'Copenhagen, Denmark'}
            work={
              'Contribute in Developing, or refactoring, and documenting the frontend. Design, develop, and implement features using Vue JS to improve the system. Build reusable code and libraries for future use. Translating Figma designs into responsive web pages by utilizing Vue JS / HTML / CSS'
            }
          />
          <Details
